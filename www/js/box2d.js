...
b2Settings.b2_angularSleepTolerance=2.0/180.0/b2Settings.b2_timeUnitsPerSecond;b2Settings.b2Assert=function(a){
    if(!a){
        var nullVec;
        nullVec.x++;
    }
    ...
    RemovePair:function(proxyId1,proxyId2){
        ...
        while(node!=b2Pair.b2_nullPair){
            if(b2PairManager.Equals(this.m_pairs[node],proxyId1,proxyId2)){
                ...
                var userData=pair.userData;pair.next=this.m_freePair;
    ...
    ComputeMass:function(massData){
        ...
        switch(this.type){
            case b2Shape.e_circleShape:
                {
                    var circle=this;
                    massData.mass=this.density*b2Settings.b2_pi*circle.radius*circle.radius;massData.center.Set(0.0,0.0);
...
Object.extend(b2CircleShape.prototype,{
    ...
    ResetProxy:function(broadPhase){
        ...
        broadPhase.DestroyProxy(this.m_proxyId);proxy=null;
        var aabb=new b2AABB();
        aabb.minVertex.Set(this.m_position.x-this.m_radius,this.m_position.y-this.m_radius);
        aabb.maxVertex.Set(this.m_position.x+this.m_radius,this.m_position.y+this.m_radius);
        if(broadPhase.InRange(aabb)){
...
Object.extend(b2PolyShape.prototype,{
    ...
    initialize:function(def,body,newOrigin){
        ...
        this.m_maxRadius=0.0;
        this.m_categoryBits=def.categoryBits;
        this.m_maskBits=def.maskBits;this.m_groupIndex=def.groupIndex;
        ...
        if(def.type==b2Shape.e_boxShape){
            ...
            tVec.x=localR.col1.x*hX+localR.col2.x*hY;tVec.y=localR.col1.y*hX+localR.col2.y*hY;
...
b2Island.prototype={
    ...
    Solve:function(step,gravity){
        ...
        for(i=0;i<this.m_bodyCount;++i){
            ...
            b.m_angularVelocity+=step.dt*b.m_invI*b.m_torque;b.m_linearVelocity.Multiply(b.m_linearDamping);
...
b2Contact.Destroy=function(contact,allocator){
    ...
    var destroyFcn=b2Contact.s_registers[type1][type2].destroyFcn;destroyFcn(contact,allocator);
};
        ...
        for(var i=0;i<this.m_constraintCount;++i){
            ...
            if(b2World.s_enableWarmStarting){
                ...
                for(j=0;j<tCount;++j){
                    ...
                    b1.m_linearVelocity.x-=invMass1*PX;b1.m_linearVelocity.y-=invMass1*PY;
        ...
        if(tMani.pointCount>0){
            ...
            for(var i=0;i<tMani.pointCount;++i){
                ...
                for(var j=0;j<this.m0.pointCount;++j){
                    ...
                    if(id0.key==idKey){
                        match[j]=true;
                        cp.normalImpulse=cp0.normalImpulse;cp.tangentImpulse=cp0.tangentImpulse;
                        break;
                    }
                }
            }
    ...
    Collide:function(){
        ...
        for(var c=this.m_world.m_contactList;c!=null;c=c.m_next){
            ...
            if(oldCount==0&&newCount>0){
                ...
                body1.m_contactList=c.m_node1;node2.contact=c;
                node2.other=body1;
                node2.prev=null;
...
Object.extend(b2DistanceJoint.prototype,{
    initialize:function(def){
        this.m_node1=new b2JointNode();
        this.m_node2=new b2JointNode();
        this.m_type=def.type;this.m_prev=null;
        this.m_next=null;
        this.m_body1=def.body1;
        this.m_body2=def.body2;
        this.m_collideConnected=def.collideConnected;
        ...
        this.m_length=Math.sqrt(tX*tX+tY*tY);this.m_impulse=0.0;
    },
    PrepareVelocitySolver:function(){
        var tMat;
        tMat=this.m_body1.m_R;
        ...
        if(b2World.s_enableWarmStarting){
            var PX=this.m_impulse*this.m_u.x;var PY=this.m_impulse*this.m_u.y;
            ...
            this.m_body2.m_linearVelocity.x+=this.m_body2.m_invMass*PX;this.m_body2.m_linearVelocity.y+=this.m_body2.m_invMass*PY;
    ...
    SolvePositionConstraints:function(){
        var tMat;tMat=this.m_body1.m_R;
        var r1X=tMat.col1.x*this.m_localAnchor1.x+tMat.col2.x*this.m_localAnchor1.y;
        var r1Y=tMat.col1.y*this.m_localAnchor1.x+tMat.col2.y*this.m_localAnchor1.y;
        tMat=this.m_body2.m_R;
        var r2X=tMat.col1.x*this.m_localAnchor2.x+tMat.col2.x*this.m_localAnchor2.y;
...
Object.extend(b2GearJoint.prototype,{
    ...
    initialize:function(def){
        ...
        if(def.joint1.m_type==b2Joint.e_revoluteJoint){
            this.m_revolute1=def.joint1;this.m_groundAnchor1.SetV(this.m_revolute1.m_localAnchor1);
...
Object.extend(b2MouseJoint.prototype,{
    ...
    PrepareVelocitySolver:function(){
        ...
        this.K1.col2.x=0.0;this.K1.col1.y=0.0;
...
Object.extend(b2PrismaticJoint.prototype,{
    ...
    GetReactionForce:function(invTimeStep){
        ...
        var tMat;
        tMat=this.m_body1.m_R;var ax1X=tImp*(tMat.col1.x*this.m_localXAxis1.x+tMat.col2.x*this.m_localXAxis1.y);
    ...
    SolveVelocityConstraints:function(step){
        ...
        if(this.m_enableMotor&&this.m_limitState!=b2Joint.e_equalLimits){
            ...
            b1.m_angularVelocity+=invI1*motorImpulse*this.m_motorJacobian.angular1;b2.m_linearVelocity.x+=(invMass2*motorImpulse)*this.m_motorJacobian.linear2.x;
    ...
    SolvePositionConstraints:function(){
        var limitC;var oldLimitImpulse;
        var b1=this.m_body1;
        var b2=this.m_body2;
        var invMass1=b1.m_invMass;
        var invMass2=b2.m_invMass;
        ...
        if(this.m_enableLimit&&this.m_limitState!=b2Joint.e_inactiveLimit){
            tMat=b1.m_R;r1X=tMat.col1.x*this.m_localAnchor1.x+tMat.col2.x*this.m_localAnchor1.y;
            ...
            if(this.m_limitState==b2Joint.e_equalLimits){
                ...
                limitImpulse=-this.m_motorMass*limitC;positionError=b2Math.b2Max(positionError,b2Math.b2Abs(angularC));
            }
            else if(this.m_limitState==b2Joint.e_atLowerLimit){
                ...
                limitImpulse=-this.m_motorMass*limitC;oldLimitImpulse=this.m_limitPositionImpulse;
            ...
            b1.m_R.Set(b1.m_rotation);b2.m_position.x+=(invMass2*limitImpulse)*this.m_motorJacobian.linear2.x;
...
Object.extend(b2PulleyJoint.prototype,{
    ...
    GetLength2:function(){
        var tMat;tMat=this.m_body2.m_R;
    ...
    GetRatio:function(){
        ...
        var d1Len=Math.sqrt(tX*tX+tY*tY);tX=def.groundPoint2.x-def.anchorPoint2.x;
    ...
    PrepareVelocitySolver:function(){
        ...
        var r2X=tMat.col1.x*this.m_localAnchor2.x+tMat.col2.x*this.m_localAnchor2.y;
        var r2Y=tMat.col1.y*this.m_localAnchor2.x+tMat.col2.y*this.m_localAnchor2.y;
        var p1X=b1.m_position.x+r1X;var p1Y=b1.m_position.y+r1Y;
        var p2X=b2.m_position.x+r2X;var p2Y=b2.m_position.y+r2Y;
    ...
    SolvePositionConstraints:function(){
        ...
        var linearError=0.0;
        {
            ...
            r1Y=tMat.col1.y*this.m_localAnchor1.x+tMat.col2.y*this.m_localAnchor1.y;
            tMat=b2.m_R;r2X=tMat.col1.x*this.m_localAnchor2.x+tMat.col2.x*this.m_localAnchor2.y;
            r2Y=tMat.col1.y*this.m_localAnchor2.x+tMat.col2.y*this.m_localAnchor2.y;
            p1X=b1.m_position.x+r1X;
            p1Y=b1.m_position.y+r1Y;
            p2X=b2.m_position.x+r2X;
        ...
        if(this.m_limitState1==b2Joint.e_atUpperLimit){
            ...
            r1X=tMat.col1.x*this.m_localAnchor1.x+tMat.col2.x*this.m_localAnchor1.y;
            r1Y=tMat.col1.y*this.m_localAnchor1.x+tMat.col2.y*this.m_localAnchor1.y;
            p1X=b1.m_position.x+r1X;p1Y=b1.m_position.y+r1Y;this.m_u1.Set(p1X-s1X,p1Y-s1Y);
            length1=this.m_u1.Length();
            if(length1>b2Settings.b2_linearSlop){
...
Object.extend(b2RevoluteJoint.prototype,{
    ...
    initialize:function(def){
        ...
        this.m_localAnchor2.x=tX*tMat.col1.x+tY*tMat.col1.y;
        this.m_localAnchor2.y=tX*tMat.col2.x+tY*tMat.col2.y;
        this.m_intialAngle=this.m_body2.m_rotation-this.m_body1.m_rotation;this.m_ptpImpulse.Set(0.0,0.0);
        this.m_motorImpulse=0.0;
        this.m_limitImpulse=0.0;
        this.m_limitPositionImpulse=0.0;
    ...
    SolveVelocityConstraints:function(step){
        ...
        if(this.m_enableLimit&&this.m_limitState!=b2Joint.e_inactiveLimit){
            ...
            if(this.m_limitState==b2Joint.e_equalLimits){
                ...
                oldLimitImpulse=this.m_limitImpulse;this.m_limitImpulse=b2Math.b2Min(this.m_limitImpulse+limitImpulse,0.0);
                limitImpulse=this.m_limitImpulse-oldLimitImpulse;
            }
